...
if($_POST){
    ...
    $usuario->altServico($get['servico'],$dd['serv']);
    }
}
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Alterar Especialidades
                <small>Alterar Especialidade </small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a>
                </li>
                <li class="active">Alterar Especialidade para Clínicas</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
...
<!--                    <h3>Por favor preencha os dados abaixo</h3>-->
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?=$get['nome'];?>" name="serv" class="form-control">
                            </div>
                        </div>
