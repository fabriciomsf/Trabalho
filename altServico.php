...
if($_POST){
    $servico->altServico($cliente->getIdCliente(), $servico->getidServicosServ(), $_POST['desc']);
}
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Alterar Vinculo
                <small> </small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a>
                </li>
                <li class="active">Alterar Vinculo</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
            ...
            <!-- In order to set the email address and subject line for the contact form go to the bin/contact_me.php file. -->
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea id="inputEmail3" class="form-control" maxlength="255" name="desc" rows="3"><?=$servico->getdescricaoServ();?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                <button type="submit" class="btn btn-primary">Alterar Vinculo</button>
                            </div>
                        </div>
                    </form>
