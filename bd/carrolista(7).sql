...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Maio-2016 às 20:39
...
(4, 9, 34, 3, 'muito bom!'),
(5, 9, 34, -1, 'Relevante!'),
(6, 9, 2, 1, 'relativamente bom'),
(7, 9, 34, 3, 'aquele teste'),
(8, 9, 35, 1, 'asdadasda'),
(9, 9, 35, 3, 'dadadasdasd'),
(10, 9, 35, 3, 'dadadasdasd'),
(11, 9, 35, 3, 'dadadasdasd'),
(12, 9, 35, 3, 'dadadasdasd'),
(13, 9, 35, 3, 'dadadasdasd'),
(14, 9, 35, 3, 'dadadasdasd'),
(15, 9, 35, 3, 'dadadasdasd'),
(16, 9, 35, 3, 'dadadasdasd');
...
--
ALTER TABLE `avaliacao`
  MODIFY `idAvaliacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
