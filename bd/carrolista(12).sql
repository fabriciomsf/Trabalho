...
--
-- Host: 127.0.0.1
-- Generation Time: 14-Jun-2016 às 20:26
...
(2, 'Obrigado', 5, '2016-06-14'),
(3, 'Obrigado', 3, '2016-06-14'),
(4, 'Obrigado ', 2, '2016-06-14'),
(5, 'Entre em contato com o numero na descriÃ§Ã£o por gentileza!', 1, '2016-06-14');
...
(1, 'Alarme', 'I'),
(2, 'Alinhamento e Balanceamento', 'I'),
(3, 'Alinhamento TÃ©cnico (monobloco, longarina, chassi, suspensÃ£o)', 'I'),
(4, 'AplicaÃ§Ã£o de PelÃ­culas para Vidros', 'I'),
(5, 'Ar-condicionado', 'I'),
(6, ' Auto ElÃ©trica', 'I'),
(7, 'Auto Socorro', 'I'),
(8, 'Capotaria', 'I'),
...
--
ALTER TABLE `resposta`
  MODIFY `idResposta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
