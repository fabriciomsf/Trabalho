...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Maio-2016 às 20:33
...
INSERT INTO `avaliacao` (`idAvaliacao`, `idUsuario`, `idCliente`, `avaliacao`, `comentario`, `idResposta`) VALUES
(1, 9, 34, 2, 'asdasdasdasdasd', NULL),
(2, 9, 34, 2, 'asdasdasdasdasd', NULL);
