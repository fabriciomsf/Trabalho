...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Jun-2016 às 06:30
...
INSERT INTO `avaliacao` (`idAvaliacao`, `idUsuario`, `idCliente`, `idServico`, `avaliacao`, `comentario`, `data`) VALUES
(1, 9, 35, 11, 30, 'Fui mal atendido!', '2016-06-12'),
(2, 9, 34, 11, 100, 'Ã“timo atendimento!', '2016-06-12'),
(3, 8, 34, 11, 100, 'Ã“timo atendimento', '2016-05-12'),
(4, 8, 34, 11, 10, 'Fui mal atendido!', '2016-06-12'),
(5, 9, 21, 12, 100, 'Multo bons ServiÃ§os', '2016-06-12');
...
INSERT INTO `bairro` (`idBairro`, `nomeBairro`, `estatus`) VALUES
(1, 'CAMPO GRANDE', 'A'),
(2, 'SANTA CRUZ', 'A'),
(3, 'BANGU', 'I'),
(4, 'COSMOS', 'A'),
(5, 'SENADOR VASCONCELOS', 'A'),
(6, 'RECREIO', 'A'),
(7, 'BARRA DA TIJUCA', 'A'),
(8, 'SENADOR CAMARA', 'A'),
(9, 'SANTÃSSIMO', 'A'),
...
(34, 'Auto Eletrica Fricar', 'AVENIDA JOÃƒO XXIII', 90, 'BARRA DA TIJUCA', '23570-000', '3232-3232', '1212-5858', 'Venda de peÃ§as para veiculos <b>nacionais e importados</b>!', 'A', 6, 'e7015854e9b7faac3b94fb25bf070756.jpg', 'd4b71c674d33a618f282d1409ac146ae.jpg', '30381161452eaf0e22a7a3ba764ba283.jpg'),
(35, 'Desentorta Carro 2', 'AVENIDA JOÃƒO XXIII', 5000, 'BARRA DA TIJUCA', '23570-000', '3232-3232', '1212-5858', 'asdasdasdas', 'A', 6, '0c2586c087a05da22d21a9f921a5ba94.jpg', '8bc81bafee2d28b6849a269081e85a57.jpg', 'b4b4250196dda9ad4a78bd5db3521713.jpg');
...
INSERT INTO `resposta` (`idResposta`, `resposta`, `idAvaliacao`, `data`) VALUES
(1, 'Por favor entre em contato com o nÃºmero na descriÃ§Ã£o!', 4, '2016-06-12');
...
(3, 'Alinhamento TÃ©cnico (monobloco, longarina, chassi, suspensÃ£o)', 'I'),
...
CREATE TABLE IF NOT EXISTS `tb_serv_cli` (
...
(6, 'SERGIO MURILLO', 'SRG.MRLL@GMAIL.COM', '249bda25dbf81f81202c424ca892d987', 0),
